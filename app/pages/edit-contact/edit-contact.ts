...
export class EditContactPage {
  ...
  constructor( private app: IonicApp, private nav: NavController, private navParams: NavParams, private viewController: ViewController, private formBuilder: FormBuilder, private contactService: ContactService ) {
    ...
    editContact(event) {
        if(!this.contactForm.valid) {
            ...
            this.contactService.editContact( contact, successCallback, errorCallback, successCallbackComponent, errorCallbackComponent);
        }
    }
                ...
                buttons: [
                    {
                        ...
                        handler: () => {
                            ...
                            this.contactService.deleteContact( this.contact, successCallback, errorCallback, callbackComponent);
                        }
                    },
                    {
                        text:'No',
    ...
    private validateContact(){
        ...
        if (!this.contact.addressStreet){
            this.contact.addressStreet = "";
        }
        if (!this.contact.addressCity){
            this.contact.addressCity = "";
        }
        if (!this.contact.addressState){
            this.contact.addressState = "";
        }
        if (!this.contact.addressCode){
            this.contact.addressCode = "";
        }
        if (!this.contact.addressCountry){
            this.contact.addressCountry = "";
        }
